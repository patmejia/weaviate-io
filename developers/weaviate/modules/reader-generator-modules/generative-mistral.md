...
This configuration enables `generative-mistral` and sets the AWS authentication credentials.
...
services:
  weaviate:
    ...
    environment:
      ...
      ENABLE_MODULES: 'text2vec-cohere,generative-mistral'  # Can be any `text2vec` module.
      # highlight-end
...
The following example configures the `Document` class to use the `generative-mistral` module with the `Document` class, with the `meta-llama/Llama-2-70b-chat-hf` model.
...
| :- | :- | :- | :- |
| `"X-Mistral-Api-Key"` | Your Mistral API key. | Authentication | [Learn more](https://docs.mistral.ai/api/)|
...
import MistralSingleResult from '/_includes/code/generative.anyscale.singleresult.mdx';
...
import MistralGroupedResult from '/_includes/code/generative.anyscale.groupedresult.mdx';
...
<!-- Weaviate 1.24.2 introduces the `generative-mistral` module,  -->
